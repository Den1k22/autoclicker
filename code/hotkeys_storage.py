...
HOTKEY_TAGS = (ADD_POINT_HOTKEY, REMOVE_LAST_POINT_HOTKEY, REMOVE_ALL_POINTS_HOTKEY,
               START_AUTOCLICKER_HOTKEY, STOP_AUTOCLICKER_HOTKEY, ONE_AUTOCLICK_RUN_HOTKEY,
               SAVE_POINTS_HOTKEY, LOAD_POINTS_HOTKEY, CREATE_MESH_HOTKEY,
               START_STOP_CV_HOTKEY, EXIT_HOTKEY)
