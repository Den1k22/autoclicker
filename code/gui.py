...
class MainFrame (wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.points_section_name = wx.StaticText(self.points_setion_panel, wx.ID_ANY, _(
        ...
        self.mesh_options_radio_box = wx.RadioBox(self.mesh_panel, wx.ID_ANY, _(
        ...
        self.value_int_name = wx.StaticText(self.valuel_int_panel, wx.ID_ANY, _(
        ...
        self.hotkeys_group_name = wx.StaticText(self.hotkeys_group_name_panel, wx.ID_ANY, _(
        ...
        self.hotkey_name = wx.StaticText(self.hotkey_control_panel, wx.ID_ANY, _(
        ...
        self.save_menu_item = wx.MenuItem(self.file_menu, wx.ID_ANY, _(
            u"Save") + u"\t" + u"Ctrl+S", wx.EmptyString, wx.ITEM_NORMAL)
        self.file_menu.Append(self.save_menu_item)

        self.load_menu_item = wx.MenuItem(self.file_menu, wx.ID_ANY, _(
        ...
        self.about_menu_item = wx.MenuItem(self.help_menu, wx.ID_ANY, _(
...
class AboutDialog (wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.about_autoclicker_message_label = wx.StaticText(self, wx.ID_ANY, _(
