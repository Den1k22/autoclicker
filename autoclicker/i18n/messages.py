...
if False:  # Babel extracts these calls; application code translates them later.
    ...
    gettext("The legacy points file could not be migrated: {error}")
    gettext("The preset points file could not be loaded: {error}")
    ngettext("{count} point", "{count} points", 1)

    gettext("Language must be English or Russian.")
    gettext("Preset name cannot be empty.")
    gettext("Points path cannot be empty.")
    ...
    gettext("Hotkey is reserved for preset selection.")
